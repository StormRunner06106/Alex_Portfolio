...
[813-402-8692](tel:+18134028692) · [alex@herlan.dev](mailto:alex@herlan.dev) · [alex.herlan.dev](https://alex.herlan.dev) · [LinkedIn](https://linkedin.com/in/alexander-herlan) · [GitHub](https://github.com/AlexanderHerlan)
...
- Built an administrative portal with statistical dashboards for membership, onboarding, qualifications, payments, and course progress. Automated programme-timeline calculations, approved-leave handling, certificate issuance, and several previously manual documentation workflows.
...
- Deployed the platform on Cloudflare using Workers for server-side execution, D1 for relational data, Durable Objects for real-time messaging, and R2 for document storage. Used AI-assisted development with Codex to accelerate implementation and iteration while maintaining system stability.
...
- **SQL:** Microsoft SQL Server, MySQL Server, PostgreSQL Server
- **NoSQL:** MongoDB, CouchDB, Redis
- **Other:** Microsoft Access, Microsoft Excel
...
- Advanced Photoshop
- Introduction to Lightwave 3D

## References

| Name | Role | Organization | Phone |
| --- | --- | --- | --- |
| David Foy | Senior Software Engineer | Covius | [407-954-1245](tel:+14079541245) |
| Warren Wright | CEO | SEAD Software | [201-988-1513](tel:+12019881513) |
| Ashley Park | Director | Clarity Diagnostics | [508-341-5387](tel:+15083415387) |
| Douglas Radecki | CEO | MyTap / Which Craft | [505-400-4636](tel:+15054004636) |
